...
function to_slot_dir(){
  if (!slotdir_win || slotdir_win.closed) {
    slotdir_win = window.open("./components/specs/slotdictionary.html","SlotDictionary",
...
function search () {
  ...
  if (!search_win || search_win.closed) {
    search_win = window.open("./proxy-search.cgi?build="+build, "search", "width=600,height=600,status=yes,resizable=yes,scrollbars=yes");
